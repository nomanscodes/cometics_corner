...
import ShopPageMobilePortion from "@/components/ShopPage/ShopPageMobilePortion";
        ...
        <div className="md:w-64 lg:w-auto col-span-2  bg-white px-4 py-2 shadow-md">
          <div className="">
            <div className="flex items-center justify-between ">
              ...
              <a className=" font-semibold text-sm text-bgColor cursor-pointer">
                CLEAR ALL
              </a>
            </div>
          ...
          <div className="brandSection mt-7">
            ...
            <div className="flex w-full relative mt-2">
              ...
              />
              <AiOutlineSearch
                className=" absolute left-0 mt-[7px] text-gray-500 border-solid border-neutral-500"
                size={18}
              />
            </div>
            <div
            ...
            {moreBrand ? (
              <>
                <span
                  onClick={() => setMoreBrand(false)}
                  className="text-sm font-semibold text-bgColor cursor-pointer"
                >
                  MORE LESS
                </span>
              </>
          ...
          <div className="skinType mt-5 mb-2 px">
            <span className="filter flex items-center gap-3  bg-gray-100 p-1">
              <picture>
                <img className="w-3" src="/SVG/leftalignment.svg" alt="" />
              </picture>
              <p className="font-semibold text-xs">SKIN TYPE</p>
            </span>
            <div className="mt-3">
              <div className="flex items-center justify-between mt-2">
                <span className="flex items-center gap-2">
        ...
        <div className="col-span-7 w-full">
          <div className="bg-white p-2">
            ...
            <div className="flex items-center gap-2 mt-3">
              <h1 className="text-sm font-medium opacity-80 uppercase">
                Mackup
              </h1>
              <span className="text-xs opacity-60">
                (Showing 1 – 24 products of 7,993 products)
              </span>
            </div>
            <div className="flex items-center gap-3 mt-3 uppercase">
              ...
              <h1 className="text-xs font-medium opacity-80 hover:text-bgColor transition transform hover:-translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none cursor-pointer text-[#142b17]">
                popularity
              </h1>
              <h1 className="text-xs font-medium opacity-80 hover:text-bgColor transition transform hover:-translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none cursor-pointer">
                price-low to-high
              </h1>
              <h1 className="text-xs font-medium opacity-80 hover:text-bgColor transition transform hover:-translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none cursor-pointer">
                price-high to-low
