        ...
        <div className='bg-white relative'>
            <div className='flex items-center gap-2 mt-1 p-2'>
                ...
                <div className='discountSection'>
                    <span onClick={() => setDiscount(true)} className='flex items-center border border-bgColor gap-1 px-3 py-1 rounded-full'>
                ...
                <div className='priceSection'>
                    <span onClick={() => setPrice(true)} className='flex items-center border border-bgColor gap-1 px-3 py-1 rounded-full'>
