...
const ChatIcon = () => {
    ...
    return (
        <div className="fixed bottom-16 right-1 md:bottom-4 md:right-6 z-50 ">
            <div onClick={() => setshowMessageBar(!showMessageBar)} className="bg-[#085e54] p-[9px] md:p-2 h-10 w-10 md:h-12 md:w-12 rounded-full flex items-center justify-center  cursor-pointer z-40">
                <picture>
                    ...
                    <div className="reciveMessage flex items-end gap-2">
                        ...
                        <div className="bg-white w-fit max-w-[220px] md:max-w-[250px] rounded-lg rounded-bl-none shadow">
                            <div className="text-[11px] font-medium p-[6px] md:p-2">
                                jdlfsdl dhfsdf sdfdns shfffs fggfgfd jkfjdsfei fsd kfsdlkf
                                fdfds fkjsdlslsdfsd dflsd
                            </div>
