    ...
    return (
        <>
            <div className='bg-white border shadow-sm'>
                <h3 className='p-3 text-bgColor text-[15px] font-medium'>Profile</h3>
                <hr />
                ...
                <div className='p-3'>
                    ...
                    <div className='mt-5'>
                        <div className='w-3/5'>
                            <h3 className='text-[15px] font-semibold text-zinc-900'>What is your prefred affiliate store ID ?</h3>
                            ...
                            <h3 className='text-[15px] font-semibold text-zinc-900 mt-4'>Tell us about the content you create</h3>
                            <textarea type="text" className='py-[8px] md:py-[7px] flex flex-1 w-[100%] text-[12px] md:text-[14px] pl-2 rounded-md md:rounded-sm focus:outline-none border border-gray-500 mt-2 min-h-[150px]' />
                            ...
                            <div className='mt-3 '>
                                <h3 className='text-[15px] font-semibold text-zinc-900'>Which of the following best describe your content ? </h3>
                                ...
                                <div className='mt-4'>
                                    <h3 className='text-[15px] font-semibold text-zinc-900'>How did you here about us ?</h3>
                        ...
                        <div className='mt-3'>
                            <p className='mt-2 text-[13px]'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem tenetur adipisci porro quam minus mollitia impedit esse, suscipit iste Autem tenetur adipisci porro quam minus mollitia impedit esse, suscipit iste </p>
                            ...
                            <h3 className='text-[15px] font-semibold text-zinc-900 mt-2'>Type the charecters in the above image</h3>
            ...
            <div className='mt-3 flex items-center justify-between'>
                ...
                <span onClick={() => submitHandeler()} className='flex items-center gap-2 px-4 py-[6px] bg-bgColor rounded md:cursor-pointer'>
                    <h1 className='text-[14px] font-medium'>Finish</h1>
                    <picture>
                        <img src="/SVG/arrowBold.svg" className='w-4 opacity-80' alt="" />
                    </picture>
                </span>
            </div>
        </>
